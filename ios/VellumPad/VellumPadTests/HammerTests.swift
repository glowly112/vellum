...
final class HammerTests: XCTestCase {
    ...
    func testImportBackdatesAndSkipsDuplicates() {
        ...
        XCTAssertEqual(ImportLook.sourceMarkKind, "drawn")
        XCTAssertFalse(ImportMarkLook.usesSF)
        XCTAssertFalse(ImportMarkLook.usesGenericCircle)
        XCTAssertEqual(ImportMarkLook.notes, "yellow-pad")
        XCTAssertEqual(ImportMarkLook.journal, "brown-book")
        XCTAssertEqual(ImportMarkLook.notion, "n")
        XCTAssertEqual(ImportSource.notes.markKind, "yellow-pad")
        ...
        XCTAssertEqual(WelcomeCopy.kicker, "Velin")
