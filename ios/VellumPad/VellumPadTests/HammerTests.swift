...
final class HammerTests: XCTestCase {
    ...
    func testLibraryComposeIsSystemNotACustomPill() {
        ...
        XCTAssertEqual(LibraryGreeting.belowGreeting, 16)
        XCTAssertEqual(LibraryGreeting.belowGreetingKind, "title-to-subtitle")
        XCTAssertGreaterThan(LibraryGreeting.belowGreeting, 0)
