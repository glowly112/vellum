...
final class HammerTests: XCTestCase {
    ...
    func testImportBackdatesAndSkipsDuplicates() {
        ...
        XCTAssertFalse(SettingsLook.hasThemePicker)
        XCTAssertTrue(SettingsLook.followsSystemAppearance)
        XCTAssertEqual(SettingsLook.aboutCopy, "Pages stay on this iPhone.")
        XCTAssertEqual(SettingsLook.versionLabel, "1.0.0 (28)")
        XCTAssertEqual(SettingsLook.buildNumber, "28")
        ...
        XCTAssertEqual(WelcomeCopy.pages[2].title, "Bring thoughts in.")
