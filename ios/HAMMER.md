...
| 5 | KB_COVER | No guessed pad (not 34 / 42 / 44 / 120). Word-count is a caption on the keys. Caret floor is **0**. Leftover slack sits **above** the column while following (Mini 18’s 72pt). Editor hugs the measured body — 280 is not parked under the last line. Clearance is a few points, not a pitch. Closed origin stays. Not pinned to the bottom. |
