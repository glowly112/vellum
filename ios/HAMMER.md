...
| 5 | KB_COVER | No guessed pad (not 34 / 42 / 44 / 120). Word-count is a caption on the keys. Caret parks on the **live UITextInput caret rect** a few points above the hairline (not scrollTo(body) / a field-size no-op). Mini 42pt high is a top inset; phone clip is a bottom inset. Closed origin stays. Not pinned to the bottom. |
