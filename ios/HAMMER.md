...
| 5 | KB_COVER | No guessed pad (not 34 / 42 / 44 / 120). Word-count is a caption on the keys. Caret field is container − **live layout-guide pad** − measured inset (phone keyboard + suggestion bar is not Mini-sized). Slack sits above the column. Floor is 0. Editor hugs the measured body. Clearance is a few points, not a pitch. Closed origin stays. Not pinned to the bottom. |
