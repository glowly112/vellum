...
| 5 | KB_COVER | No guessed pad (not 34 / 42 / 44 / 120). Word-count is a caption on the keys. Caret floor is slack under the **column** (not visible − one line). Scroll parks the **body**, not the floor. Closed origin stays. Not pinned to the bottom. |
