...
| 5 | KB_COVER | No guessed pad (not 34 / 42 / 44 / 120). Open writing pad is **keyboard-only** (guide minus resting). Closed pad is resting (home indicator). Word-count is a caption on the keys. Gutters are **paper**. Lift is `layout-guide`. |
