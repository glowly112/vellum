...
| --- | --- | --- | --- | --- |
| Library (`LibraryView`) | [Apple Notes library](https://mobbin.com/screens/497d6ce0-454b-4f98-b8e7-15a2560b509c) | `library-notes.jpg` | Large title, recency groups, glass circular bar buttons, bottom search + compose | Folders, notebooks, a notes thumbnail grid if Vellum paper cards read better as a list |
...
| --- | --- | --- |
| Library cards, greeting, recency | `vellum-library.png` | Paper stamp on the card (colour, ruling, type, word count). Recency: Today / Yesterday / This week / Earlier |
