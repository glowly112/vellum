...
| Editor paper | [Apple Notes blank ruled sheet](https://mobbin.com/screens/dc7e5d8a-f469-41cc-98c7-2aff7e58b84c) | `paper-notes.jpg` | Quiet floating chrome, keyboard-aware `TextEditor` | Full-bleed Notes page that lost the sheet. The page is a rounded sheet on the grain desk |
...
| Title + body on paper | `vellum-editor.png` | Cream / ivory / ruled / etc. sheet sitting on the grain desk. Date, title, body, and `N words` / `Cream · Book` live on that sheet |
