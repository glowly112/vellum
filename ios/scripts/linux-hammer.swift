...
enum LinuxHammer {
    static func main() {
        ...
        expect(SettingsLook.versionLabel == "1.0.0 (30)", "about version is 1.0.0 (30)")
        expect(SettingsLook.buildNumber == "30", "build number is 30")
        ...
        expect(!WelcomeLook.libraryBehind && !WelcomeLook.hasStamp, "no library behind welcome; no name stamp")
