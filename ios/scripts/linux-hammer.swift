...
enum LinuxHammer {
    static func main() {
        ...
        expect(SettingsLook.versionLabel == "1.0.0 (31)", "about version is 1.0.0 (31)")
        expect(SettingsLook.buildNumber == "31", "build number is 31")
        ...
        expect(WelcomeLook.openingBeat == "stamp-bounce" && WelcomeLook.autoAdvanceAfterStamp, "stamp bounces then advances")
        expect(WelcomeLook.bounceResponse == DeskMotion.response && WelcomeLook.bounceDamping == DeskMotion.damping, "stamp bounce is the delete spring")
        expect(WelcomeLook.bounceSettle == 0.95 && WelcomeLook.cardsArrive && WelcomeLook.typesWriting, "settle, cards arrive, writing types")
