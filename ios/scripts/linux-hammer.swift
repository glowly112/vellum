...
enum LinuxHammer {
    static func main() {
        ...
        expect(KeyboardAvoidance.wordCountAir > 0 && KeyboardAvoidance.wordCountAir != 34 && KeyboardAvoidance.wordCountAir != 120, "E5 word-count air is not a guessed pad")
        ...
        expect(KeyboardChrome.writingBottomPad(guidePad: 280) == 280, "E5 writing pad is the guide, not a guess")
