...
expect(LibraryLook.cellKind == "paper-sheet", "library cell is a paper sheet")
expect(LibraryLook.greetingFamily == "Fraunces", "greeting is Fraunces not SF")
expect(LibraryLook.composeKind == "system", "compose stays system")
expect(LibraryLook.sheetMinHeight >= 160, "sheet is a page not a thumbnail")
