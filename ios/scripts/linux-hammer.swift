...
enum LinuxHammer {
    static func main() {
        ...
        expect(LibraryGreeting.belowGreeting == 16, "5 air under the greeting")
        expect(LibraryGreeting.belowGreetingKind == "title-to-subtitle", "5 gap is title-to-subtitle")
        expect(LibraryGreeting.belowGreeting > 0, "5 greeting-to-date gap is present")
        expect(!LibraryGreeting.forbiddenGuessedPads.contains(LibraryGreeting.belowGreeting), "5 below-greeting is not a 34 guess")
