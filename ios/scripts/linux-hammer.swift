...
enum LinuxHammer {
    static func main() {
        ...
        expect(EditorLook.deskInset > 8, "E1 some desk peeks at the sides")
        expect(EditorLook.deskInset < 20, "E1 24pt sides made a postcard")
        expect(EditorLook.deskBottom > 8 && EditorLook.deskBottom < 24, "E1 thin desk below, not 40pt")
        expect(EditorLook.sheetMaxHeightFraction >= 0.88, "E1 page is the majority of the field")
        expect(EditorLook.sheetMaxHeightFraction < 1, "E1 not a full-bleed Notes page")
        ...
        expect(editorSheetH > editorField * 0.85, "E1 page is large enough to write on")
        expect(editorSheetH < editorField, "E1 sheet is shorter than the field")
        expect(editorField - editorSheetH < editorField * 0.18, "E1 leftover is a thin desk frame")
