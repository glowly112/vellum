...
enum LinuxHammer {
    static func main() {
        ...
        expect(!EditorLook.isFullBleed, "E1 sheet is not full-bleed Notes")
        expect(EditorLook.deskPeek > 0 && EditorLook.deskPeek < 16, "E1 grain is edge-only")
        ...
        expect(EditorLook.grainReveal == "edge-only", "E1 grain is edge-only")
        ...
        expect(EditorLook.writingHeight(inField: 668) == 668 - EditorLook.deskPeek * 2, "E1 paper uses the field minus peek")
